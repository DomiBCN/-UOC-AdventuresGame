...
public class StoryFiller : MonoBehaviour
{
    ...
    public static GamePlayManager.StoryNode FillStory()
    {
        ...
        GamePlayManager.StoryNode node3 = CreateNode("Parece que habla de plantas, qué sorpresa. Hay una señalada, se llama plantus corrientis", new string[] { "Dejar el libro en su sitio y explorar el resto de objetos de la habitación" });
        ...
        GamePlayManager.StoryNode node7 = CreateNode("Los cajones estan vacíos, mejor explorar otra cosa", new string[] { "Volver a explorar los otros objetos" });
